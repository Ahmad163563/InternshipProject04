      ...
      body: Column(
        ...
        children: [
          ...
          Row(
            children: [
              SizedBox(width: 10,),
              Icon(Icons.check_circle,color: Color(0xff498200),),
              Text('  8 characters minimum',style: GoogleFonts.jost(
                fontSize: 18,
                fontWeight: FontWeight.w400,
          ...
          Row(
            children: [
              SizedBox(width: 10,),
              Icon(Icons.check_circle,color: Color(0xff498200),),
              Text('  a number',style: GoogleFonts.jost(
                  fontSize: 18,
                  fontWeight: FontWeight.w400,
                  color: Color(0xff4C4A53)
              ),)
          ...
          Row(
            children: [
              SizedBox(width: 10,),
              Icon(Icons.check_circle,color: Color(0xff498200),),
              Text('  one symbol minimum',style: GoogleFonts.jost(
                  fontSize: 18,
                  fontWeight: FontWeight.w400,
                  color: Color(0xff4C4A53)
              ),)
